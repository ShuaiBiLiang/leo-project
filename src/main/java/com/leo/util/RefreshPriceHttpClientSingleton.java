 ...
 */
public class RefreshPriceHttpClientSingleton {

        public static boolean noReturnClient;
        public static CloseableHttpClient customerHttpClient;
        private RefreshPriceHttpClientSingleton(){
    ...
    public static CloseableHttpClient getManagerClient(){
        ...
        // 将目标主机的最大连接数增加到200    //www.platform.leocoin.org
    ...
    public static boolean isNoReturnClient() {
        return noReturnClient;
    }

    public static void setNoReturnClient(boolean noReturnClient) {
        RefreshPriceHttpClientSingleton.noReturnClient = noReturnClient;
    }
